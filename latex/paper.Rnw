...
\begin{abstract}
  ...
  to compare ranked lists in order to investigate similarities
...
1994 to May 1999. We use a random subsample of $119$ patients with a
total of $58$ patients with malignant ovarian cancers as cases and
$61$ patients with benign ovarian tumors as controls. The DACOVA study
is similarly a multidisciplinary Danish study on ovarian cancer
covering about $66\%$ of the population in Denmark
\cite{bertelsen1991protocol}. It was attempted to continuous enroll
all patients referred for surgery with an ovarian tumor clinically
suspected to be cancer during the period 1984 to 1990. We use a random
subsample of $113$ patients with a total of $54$ malignant ovarian
cancers and $59$ benign ovarian tumors/gynecologic disorders.
...
agreement can be applied in two different scenarios: i) assessing the
agreement of ranking the importance of the predictors using different
statistical classification methods and ii) assessing the agreement of
rankings the predictions (the probability of the classifying a tumor
as malignant) subject to perturbations in data. In the latter case we
further illustrate the discrepancy between the ranking stability of
different statistical methods through a simulation study.


\subsection{Agreement of predictor ranking}

#includegraphics marginalVsModel.pdf


\subsection{Agreement of predictions}

#includegraphics thomas.pdf

#includegraphics simulationTest2.pdf
