...
Here we apply the same statistical classification
method to XX bootstrap samples of the MALOVA data to obtain four
prediction models. From each model we predict the risks of a malignant
patients in the DACOVA study.  Finally we estimate the agreement of
the resulting XX rankings of the DACOVA patients to illustrate the
sensitivity of the corresponding statistical classification method to
pertubations of the learning data.
