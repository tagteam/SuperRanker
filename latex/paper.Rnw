\documentclass[12pt,a4paper]{statsoc}
...
\title[Sequential rank agreement]{Sequential rank agreement methods for comparison of ranked
  lists}
\author[Ekstrøm {\it et al.}]{Claus Thorn Ekstrøm}
\address{Affiliation,
City,
Country.}
