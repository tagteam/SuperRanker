...
\begin{figure}[tb]
   \begin{center}
 \includegraphics[width=.5\textwidth]{paper-fig1a}%
 \includegraphics[width=.5\textwidth]{paper-fig2a}%
 \includegraphics[width=.5\textwidth]{paper-fig1b}%
 \includegraphics[width=.5\textwidth]{paper-fig2b}
 \end{center}
...
\begin{figure}[tb]
\begin{center}
\includegraphics[width=.5\textwidth]{paper-fig-ao1}
\includegraphics[width=.5\textwidth]{paper-fig-ao2}
\end{center}
