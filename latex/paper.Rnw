...
in the levels of rank agreement then this suggests that there are changes
in the levels of agreement. In particular, we generally expect the
agreement among the lists to be better towards the top of the lists
and worse towards the end of the lists, and in this case the sequential rank
