...
\emph{better} agreement than in the tails of the lists.
...
options(SweaveHooks=list(fig=function() par(cex.lab=1.5, cex.axis=1.5, cex.main=1.5, cex.sub=1.5)))
...
nreference <- 20
## Plot the line
plot(res[1:ysize], col="black", lwd=3, type="l", ylim=c(0,1300), ylab="Sequential rank agreement", xlab="Depth", cex=1.6)
...
$\widetilde H_0$ each based on $400$ permutations. Not surprisingly, the
