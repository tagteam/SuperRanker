...
\begin{align}
\inf \left\{d : \widehat{\textrm{sra}}_L(d) \geq \widehat{q}_L(d)\right\} = \inf \left\{d : \widehat{\textrm{sra}}_L(d) \geq q(d) + o_P(1)\right\}\\
\inf \left\{d : \widehat{\textrm{sra}}_L(d) \geq q(d)\right\}
\end{align}
This completes the proof.
