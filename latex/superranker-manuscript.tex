...
\end{align}
where we allow the threshold function to depend on the sample size as well. The estimated change-point is therefore
\begin{align}
...
\mcomment{Elaborate more on how to apply this in practice (finite
  sample/bootstrap/etc.) and that $q$ is similar to LoA BA-style? Show
some result althrough }
