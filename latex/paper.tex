...
found in the set $S_d$: [FIX: we have talked about this before, but does that redundant (L-1) factor help wrt interpretation?]
\begin{align}
\textrm{sra}(d)&= \frac{\sum_{\{p \in S_d\}}(L-1)\E[A(X_p)]}{(L-1)|S_d|}\label{def:sra}\\
   &= \sum_{\{p \in S_d\}}|S_d|^{-1} \E[A(X_p)]
\end{align}
