...
be zero for all values of $d$. %position or depths $d$ down the lists.
...
\begin{proof}
See Appendix A in the supplementary material.%\ref{sec:appA}.
\end{proof}
\end{theorem}
...
\begin{proof}
See Appendix B in supplementary material.%\ref{sec:appB}.
\end{proof}
\end{corollary}
